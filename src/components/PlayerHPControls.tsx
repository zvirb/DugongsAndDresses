            ...
            <div className="flex flex-col gap-6 w-full">
                <div className="flex gap-4">
                    <Button
                        ...
                        disabled={isPending}
                        className="flex-1 h-24 text-3xl font-bold rounded-2xl border-b-4 border-red-950 active:translate-y-1 active:border-b-0 active:scale-[0.98] transition-all"
                    >
                        -1
                    </Button>
                    <Button
                        ...
                        onClick={() => handleUpdate(1)}
                        disabled={isPending}
                        className="flex-1 h-24 text-3xl font-bold rounded-2xl border-b-4 border-emerald-950 active:translate-y-1 active:border-b-0 active:scale-[0.98] transition-all"
                    >
                        +1
                    </Button>
                </div>
                <div className="flex gap-4">
                    <Button
                        ...
                        disabled={isPending}
                        className="flex-1 h-20 text-2xl font-bold rounded-2xl border-b-4 border-red-950 active:translate-y-1 active:border-b-0 active:scale-[0.98] opacity-90 transition-all"
                    >
                        -5
                    </Button>
                    <Button
                        ...
                        onClick={() => handleUpdate(5)}
                        disabled={isPending}
                        className="flex-1 h-20 text-2xl font-bold rounded-2xl border-b-4 border-emerald-950 active:translate-y-1 active:border-b-0 active:scale-[0.98] opacity-90 transition-all"
                    >
                        +5
                    </Button>
                </div>
