...
export default async function PlayerPage({ params }: PlayerPageProps) {
    ...
    const hpColorClass = character.hp <= character.maxHp * 0.2 
    ...
    return (
        <div className="min-h-screen bg-agent-navy text-white font-sans flex flex-col">
            ...
            <header className="p-4 flex items-center justify-between border-b border-white/10 bg-agent-navy/50 backdrop-blur-md sticky top-0 z-20">
                <Link href="/player" className="p-2 -ml-2 text-neutral-400 hover:text-white transition-colors">
            ...
            <main className="flex-1 p-4 space-y-6 pb-24">
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-baseline mb-2">
                        ...
                        <div className="text-right">
                            <span className="text-5xl font-black italic tracking-tighter">{character.hp}</span>
                            <span className="text-xl text-neutral-600 font-medium ml-1">/ {character.maxHp}</span>
                        </div>
                    </div>
            ...
            {/* Bottom Navigation / Actions (Optional for future expansion) */}
            <nav className="fixed bottom-0 left-0 right-0 p-4 bg-agent-navy/80 backdrop-blur-xl border-t border-white/10 z-30 flex justify-around">
                <Link href={`/player/${id}`} className="flex flex-col items-center gap-1 text-agent-blue">
                ...
                <div className="flex flex-col items-center gap-1 text-neutral-600 opacity-50">
                    <div className="w-6 h-6 flex items-center justify-center">
