...
│   ├── play/         # [PLANNED] Mobile Player Interface
│   └── actions.ts    # Server Actions (Mutations: Roll, HP, Turn)
├── components/
│   ├── DiceRoller.tsx    # Digital Dice Logic
│   ├── TurnTracker.tsx   # Initiative Management
│   ├── AICopyButton.tsx  # Context Generation for LLMs
│   └── HPControls.tsx    # Rapid Health Editing
└── lib/
